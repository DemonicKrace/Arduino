...
int setupBlueToothConnection()
{
    ...
    */
    ...
    sendBlueToothCommand("AT+NAMEHM-Soft");//set EDR name
    ...
    //return -1;//detect if the module exists
    if(sendBlueToothCommand("AT") == 0){
      Serial.print("Setup complete\r\n\r\n");
    }
    else{
      Serial.print("Setup fail\r\n\r\n");
    }
    return 0;
}
...
//          Serial.println(t);
    ...
    {              
//        Serial.println("blueToothSerial.available && (i < 100)");                              
        recv_str[i] = char(blueToothSerial.read());
        i++;
    }
    recv_str[i] = '\0';
